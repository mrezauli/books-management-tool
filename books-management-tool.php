...
define( 'BOOKS_MANAGEMENT_TOOL_PATH', plugin_dir_path( __FILE__ ) );
define( 'BOOKS_MANAGEMENT_TOOL_URL', plugin_dir_url(  __FILE__ ) );
...
function activate_books_management_tool() {
	...
	$bmtActivator = new Books_Management_Tool_Activator();
	$bmtActivator->activate();
}
...
function deactivate_books_management_tool() {
	...
	$bmtDeactivator = new Books_Management_Tool_Deactivator();
	$bmtDeactivator->deactivate();
}
