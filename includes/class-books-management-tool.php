...
class Books_Management_Tool {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('wp_ajax_first_ajax_action', $plugin_admin, 'first_ajax_action');
		// Action Hook for action_add_bookshelf
		$this->loader->add_action('wp_ajax_action_add_bookshelf', $plugin_admin, 'action_add_bookshelf');
